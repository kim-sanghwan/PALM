...
class LabeledFeatureDataset(torch.utils.data.IterableDataset):
    ...
    def load_egovlp_feature(self, clip_uid, action_idx):
        if 'train' in self.filename:
            filename_egovlp = f'/directory/to/train/egovlp/feature/{clip_uid}_{action_idx}.pt'
        elif 'val' in self.filename:
            filename_egovlp = f'/directory/to/val/egovlp/feature/{clip_uid}_{action_idx}.pt'
        else:
            filename_egovlp = f'/directory/to/test/egovlp/feature/{clip_uid}_{action_idx}.pt'
